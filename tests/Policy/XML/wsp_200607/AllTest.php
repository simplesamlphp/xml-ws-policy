...
/**
 * Class \SimpleSAML\WebServices\Policy\XML\wsp_200607\AllTest
 *
...
final class AllTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/wsp/200607/All.xml',
        );
    }
    ...
    public function testUnmarshallingEmptyElement(): void
    {
        $xmlRepresentation = DOMDocumentFactory::fromString(
            '<wsp:All xmlns:wsp="http://www.w3.org/2006/07/ws-policy" />',
        );

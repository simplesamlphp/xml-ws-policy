...
use SimpleSAML\WebServices\Policy\XML\wsp_200607\All;
...
/**
 * Class \SimpleSAML\WebServices\Policy\XML\wsp_200607\ExactlyOneTest
 *
...
final class ExactlyOneTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$xmlRepresentation = DOMDocumentFactory::fromFile(
            dirname(__FILE__, 4) . '/resources/xml/wsp/200607/ExactlyOne.xml',
        );
    }
    ...
    public function testUnmarshallingEmptyElement(): void
    {
        $xmlRepresentation = DOMDocumentFactory::fromString(
            '<wsp:ExactlyOne xmlns:wsp="http://www.w3.org/2006/07/ws-policy" />',
        );
